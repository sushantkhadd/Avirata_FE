...
export class Module514Component implements OnInit {
  ...
  finishCFU(e) {
    if (e) {
      ...
      item => item.source == "module 5.14.1");
      if(moduleJson["children"][index1].url !="" && moduleJson["children"][index1].url !=null && moduleJson["children"][index1].url !=undefined){
        this.parentUrlJson['5.14.1'] = moduleJson["children"][index1].url;
      }
      }
      this.parentUrlJson['5.14.2'] = e['url'];
      ...
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module5.subMenu5-14'), "next": this.translate.instant('L2Module5Finish.subMenu5-15'), "nextRoute": "/modules/module5/Module5.15" }
