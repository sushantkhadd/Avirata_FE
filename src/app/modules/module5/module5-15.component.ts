...
export class Module515Component implements OnInit {
  ...
  finishCFU(e) {
    if (e) {
      ...
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module5.subMenu5-15'), "next": this.translate.instant('L2Module5Finish.subMenu5-15'), "nextRoute": "/modules/module5/Module5.16" }
