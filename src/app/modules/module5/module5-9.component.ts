    ...
    this.Module5Service.apiCall(jsonBody, apiUrl).subscribe(
      data => {
        ...
        )
        {
          ...
          window.localStorage.setItem('source', 'module 5.10.1');
          var obj = {
            "type": "submodule",
            "route": true,
            "current": this.translate.instant("L2Module5.subMenu5-9"),
            "next": this.translate.instant("L2Module5Finish.subMenu5-10"),
            "nextRoute": "/modules/module5/Module5.10"
          };
          this.LocalstoragedetailsService.setModuleStatus(JSON.stringify(obj));
          this.Module5Service.setLocalStorage5(10);
        }
      },
      error => {
        this.LanguageService.handleError(error.error.message);
