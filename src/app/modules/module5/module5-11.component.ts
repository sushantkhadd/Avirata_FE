      ...
      data => {
        if (data["status"] == true) {
          if (fun == "start") {
            ...
            window.localStorage.setItem('source', 'module 5.12');
            this.Module5Service.setLocalStorage5(9);
            var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module5.subMenu5-12'), "next": this.translate.instant('L2Module5Finish.subMenu5-12'), "nextRoute": "/modules/module5/Module5.12" }
