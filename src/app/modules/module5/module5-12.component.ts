...
@Component({
  selector: 'app-module5-12',
  templateUrl: './module5-12.component.html'
})
export class Module512Component implements OnInit {
  ...
  finishCFU(result) {
    if (result["status"] == true) {
      ...
      this.Module5Service.setLocalStorage5(13);
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module5.subMenu5-12'), "next": this.translate.instant('L2Module5Finish.subMenu5-13'), "nextRoute": "/modules/module5/Module5.13" }
      this.LocalstoragedetailsService.setModuleStatus(JSON.stringify(obj));
    }
    else {
      window.localStorage.setItem('mainFlagModule5', '12');
      this.router.navigate(['/modules/module5/Module5.12']);
    }
  }
  singleCFUComplete(e) {
    this.subFlagModule5++;
  ...
  start(){
    this.LanguageService.googleEventTrack('L3SubmoduleStatus', 'Module 5.12', window.localStorage.getItem('username'), 10);
  }
