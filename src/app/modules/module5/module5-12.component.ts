      ...
      data => {
        if (data["status"] == true) {
          if (fun == "start") {
            ...
            var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module5.subMenu5-13'), "next": this.translate.instant('L2Module5Finish.subMenu5-13'), "nextRoute": "/modules/module5/Module5.13" }
