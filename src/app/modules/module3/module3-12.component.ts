      ...
      data => {
        if (data["status"] == true) {
          if (fun == "start") {
            ...
            var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module3.subMenu3-12'), "next": this.translate.instant('L2Module3Finish.subMenu3-13'), "nextRoute": "/modules/module3/Module3.12" }
