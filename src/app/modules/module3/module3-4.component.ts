...
export class Module34Component implements OnInit {
  ...
  finishCFU(e) {
    if (e) {
      ...
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module3.subMenu3-4'), "next": this.translate.instant('L2Module3.subMenu3-5'), "nextRoute": "/modules/module3/Module3.5" }
