...
export class Module33Component implements OnInit {
  ...
  ngOnInit() {
    ...
    else if (this.mainFlagModule3 == 3)
    {
      this.startVideoEvent = false;
  ...
  finishCFU(e) {
    if (e)
    {
      ...
      window.localStorage.setItem('source', 'module 3.3.2');
    ...
    {
      window.localStorage.setItem('mainFlagModule3', '3');
      this.router.navigate(['/modules/module3/Module3.3']);
    }
  }
  singleCFUComplete(e) {
    this.subFlagModule3++;
