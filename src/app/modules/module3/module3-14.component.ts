...
export class Module314Component implements OnInit {
  ...
  start() {
    ...
    // this.LanguageService.googleEventTrack('SubmoduleStatus', 'Module 4.4', window.localStorage.getItem('username'), 10);
  }
 ...
 console.log("com ",e)
    ...
    var obj = {
      ...
      next: this.translate.instant("L2Module3.subMenu3-15"),
