        ...
        if (data['message'] == "submodule finish next uuid is") {
         ...
         else if (data['message'] == "module3 finish")
         {
           ...
           window.localStorage.setItem("currentstatus", "4");
            ...
            var obj1 = { "type": "moduleFinish", "route": true, "current": this.translate.instant('L2Module3.subMenu3-18'), "next": this.translate.instant('Module4.title'), "nextRoute": "/dashboard", "finishHead": this.translate.instant('Module4.title') }
