...
export class Module36Component implements OnInit {
  ...
  finishCFU(e) {
    if (e)
    {
      ...
      window.localStorage.setItem('source', 'module 3.6.2');
      this.Module3Service.setLocalStorage3(4);
      var obj = {
        "type": "submodule",
        "route": true,
        "current": this.translate.instant('L2Module3.subMenu3-6'),
        "next": this.translate.instant('L2Module3Finish.subMenu3-7'),
        "nextRoute": "/modules/module3/Module3.7"
      }
