...
@Component({
  ...
  templateUrl: './module0-31.component.html'
})
export class Module031Component implements OnInit {
  ...
  start1() {
    ...
    this.apiEndStart = 'baselinetwoseconetwo/';
      ...
      this.LanguageService.googleEventTrack('L3SubmoduleStatus', 'Module 0.31', window.localStorage.getItem('username'), 10);
  }
