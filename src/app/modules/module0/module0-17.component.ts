...
@Component({
  ...
  templateUrl: './module0-17.component.html'
})
export class Module017Component implements OnInit {
  ...
  ngOnInit() {
    this.lnk1 = ''
    this.lnk2 = ''
    this.urlArray["src1"] = "kKmksudB9Ak";
    this.urlArray["src2"] = "Qx_Db_6Xeqw";
    ...
    if (this.mainFlagModule0 == 17) {
      ...
      if (urlJson["children"].length > 0) {
        ...
        if (urlJson["children"][index].url != null) {
          ...
          if (mainJson != null)
          {
            this.urlArray["src1"] = mainJson["0.17.1"];
            this.urlArray["src2"] = mainJson["0.17.2"];
          } else {
            this.mapJSON();
          } 
        } else {
