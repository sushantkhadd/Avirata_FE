...
export class Module216Component implements OnInit {
  ...
  public inst =
    "विद्यार्थ्यांच्या डाव्या मेंदू इतकीच चालना विद्यार्थ्यांच्या उजव्या मेंदूला देखील मिळावी यासाठी तुम्ही कोणते उपक्रम घ्याल? कोणतीही एक संकल्पना निवडून त्याबाबत उजव्या मेंदूला चालना मिळण्याच्या दृष्टीने काय उपक्रम घ्याल ते लिहा. या आधी जी दोन उदाहरणे तुम्ही पाहिलीत, त्याआधारे आपल्या स्वतःच्या विषयासंदर्भात विचार करून लिहा. (शब्दमर्यादा किमान - १ शब्द ते कमाल १५० शब्द)";
  ngOnInit() {
    this.answer1 = "";
    this.answer2 = "";
    this.answer3 = "";
        ...
        if (data["status"] == true) {
          if (fun == "start") {
            ...
            var obj = {
              ...
              next: this.translate.instant("L2Module2Finish.subMenu2-17"),
