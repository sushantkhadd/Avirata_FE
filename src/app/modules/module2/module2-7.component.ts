...
export class Module27Component implements OnInit {
  ...
  finishCFU(result) {
    if (result["status"] == true) {
      ...
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module2.subMenu2-7'), "next": this.translate.instant('L2Module2Finish.subMenu2-8'), "nextRoute": "/modules/module2/Module2.8" }
  ...
  start(){
    this.LanguageService.googleEventTrack('L3SubmoduleStatus', 'Module 2.7', window.localStorage.getItem('username'), 10);
  }
