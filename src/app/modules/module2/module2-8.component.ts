      ...
      data => {
        if (data["status"] == true) {
          if (fun == "start") {
            ...
            var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module2.submodule2-8'), "next": this.translate.instant('L2Module2Finish.submodule2-9'), "nextRoute": "/modules/module2/Module2.9" }
