...
export class Module18Component implements OnInit {
  ...
  startFlag;
  public inst =
    "खाली काही लोकांची स्वगते दिली आहेत. त्यांना योग्य क्रमाने प्रश्न विचारा. पहिला प्रश्न विचारल्यावर आलेल्या उत्तरावर आधारित दुसरा प्रश्न विचारा.";
  ngOnInit() {
    this.queCount = 0;
        ...
        if (fun == "start1") {
          ...
          if (data["message"] == "submodule finish next uuid is") {
            ...
            var obj = {
              ...
              next: this.translate.instant("L2Module1.subMenu1-9"),
