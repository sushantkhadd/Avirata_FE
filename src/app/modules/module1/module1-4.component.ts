  ...
  start() {
    ...
    this.Module1Service.apiCall(jsonBody, apiUrl).subscribe(
      data => {
        if (data["status"] == true)
        {
          this.LanguageService.googleEventTrack('L3SubmoduleStatus', 'Module 1.4', window.localStorage.getItem('username'), 10);
      ...
      data => {
        ...
        )
        {
          ...
          var obj = {
            ...
            "next": this.translate.instant("L2Module1Finish.subMenu1-5"),
