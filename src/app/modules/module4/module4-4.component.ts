...
export class Module44Component implements OnInit {
  ...
  finishCFU(result) {
    if (result["status"] == true) {
      ...
      var obj = { "type": "submodule", "route": true, "current": this.translate.instant('L2Module4.subMenu4-4'), "next": this.translate.instant('L2Module4.subMenu4-5'), "nextRoute": "/modules/module4/Module4.5" }
