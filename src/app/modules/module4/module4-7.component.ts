...
export class Module47Component implements OnInit {
  ...
  public inst = "खालील व्यक्ती मानसिक अस्वास्थ्याच्या कक्षेत आहेत की गंभीर आजारपणाच्या हे सांगा."
  ngOnInit() {
      ...
      .subscribe(
        data => {
          ...
          } else if (data['status'] == true && data['message'] == "submodule finish")
          {
            ...
            window.localStorage.setItem('mainFlagModule4', '8');
            window.localStorage.setItem('subFlagModule4', '1');
            window.localStorage.setItem('source', 'module 4.8.1');
            var obj = {
              "type": "submodule",
              "route": true,
              "current": this.translate.instant('L2Module4.subMenu4-7'),
              "next": this.translate.instant('L2Module4Finish.subMenu4-8'),
              "nextRoute": "/modules/module4/Module4.8"
            }
            this.LocalstoragedetailsService.setModuleStatus(JSON.stringify(obj));
            this.Module4Service.setLocalStorage4(8);
          }
        },
        error => {
          this.LanguageService.handleError(error.error.message);
