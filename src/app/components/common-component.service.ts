...
export class CommonComponentService {
  ...
  constructor(public httpClient: HttpClient, public router: Router,public toastr: ToastsManager,public translate: TranslateService) { }
...
//   }
  ...
  handleError(errorMsg) {
    ...
    } else if (errorMsg == "exam not started" || errorMsg == "required quizid key" || errorMsg == "quizid is required" || errorMsg == "required useroption key" || errorMsg == "useroption is required" || errorMsg == "wrong quizid" || errorMsg == "wrong useroption")
    {
