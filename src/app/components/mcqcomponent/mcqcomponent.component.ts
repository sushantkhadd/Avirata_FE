...
export class McqcomponentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    else if(window.localStorage.getItem('mainFlagModule2')== '4' || window.localStorage.getItem('mainFlagModule2')== '6' || window.localStorage.getItem('mainFlagModule2')== '3' || window.localStorage.getItem('mainFlagModule2')== '9' || window.localStorage.getItem('mainFlagModule2')== '11'){
      this.queCount = parseInt(window.localStorage.getItem('subFlagModule2'))
    }
    else if(window.localStorage.getItem('mainFlagModule4')== '5' || window.localStorage.getItem('mainFlagModule4')== '8' || window.localStorage.getItem('mainFlagModule4')== '14' ||window.localStorage.getItem('mainFlagModule4')== '11' ||window.localStorage.getItem('mainFlagModule4')== '7'){
  ...
  ngOnChanges() {
    ...
    if (this.questionType == 'mcqYesNoOption') {
    ...
    } else if (this.questionType == 'mcqTextOption' && (window.localStorage.getItem('mainFlagModule0') == '30' || window.localStorage.getItem('mainFlagModule2')== '4' || window.localStorage.getItem('mainFlagModule2') == '9' || window.localStorage.getItem('mainFlagModule2') == '6' || window.localStorage.getItem('mainFlagModule2') == '3' || window.localStorage.getItem('mainFlagModule4') == '5' || window.localStorage.getItem('mainFlagModule4')== '11' || window.localStorage.getItem('mainFlagModule4')== '14' || window.localStorage.getItem('mainFlagModule4') == '8' || window.localStorage.getItem('mainFlagModule3') == '9' || window.localStorage.getItem('mainFlagModule3') == '11' || window.localStorage.getItem('mainFlagModule3') == '8' || window.localStorage.getItem('mainFlagModule3') == '5' || window.localStorage.getItem('mainFlagModule4')== '7' || window.localStorage.getItem('mainFlagModule5')== '7')) {
      ...
      if(window.localStorage.getItem("mainFlagModule5")=="20" || window.localStorage.getItem("mainFlagModule5")=="18"){
  ...
  onValueChanged($event) {
    ...
    if (
      ...
      if (this.showAnswer == true) {
        if (this.questionType == 'mcqTextOption' && (window.localStorage.getItem('mainFlagModule0') == '30' || window.localStorage.getItem('mainFlagModule2')== '4' || window.localStorage.getItem('mainFlagModule2') == '9' || window.localStorage.getItem('mainFlagModule2') == '6' || window.localStorage.getItem('mainFlagModule2') == '3' || window.localStorage.getItem('mainFlagModule4') == '5' || window.localStorage.getItem('mainFlagModule4')== '11' || window.localStorage.getItem('mainFlagModule4')== '14' ||window.localStorage.getItem('mainFlagModule4') == '8' || window.localStorage.getItem('mainFlagModule3') == '9' || window.localStorage.getItem('mainFlagModule3') == '11' || window.localStorage.getItem('mainFlagModule3') == '8'  || window.localStorage.getItem('mainFlagModule3') == '5' || window.localStorage.getItem('mainFlagModule4')== '7' || window.localStorage.getItem('mainFlagModule5') == '7')){
  ...
  goNext5_3() {
    ...
    this.submitFlagMCQ = false
    if (window.localStorage.getItem('mainFlagModule1')== '9' || window.localStorage.getItem('mainFlagModule2')== '4' || window.localStorage.getItem('mainFlagModule2') == '9' || window.localStorage.getItem('mainFlagModule2') == '6' || window.localStorage.getItem('mainFlagModule2') == '3' || window.localStorage.getItem('mainFlagModule3') == '11' || window.localStorage.getItem('mainFlagModule3') == '8'  || window.localStorage.getItem('mainFlagModule3') == '5' || window.localStorage.getItem('mainFlagModule4') == '5' || window.localStorage.getItem('mainFlagModule4')== '8' || window.localStorage.getItem('mainFlagModule4')== '11' || window.localStorage.getItem('mainFlagModule4')== '14' || window.localStorage.getItem('mainFlagModule4') == '7'){
      this.rankModal.show()
      this.lang.toShow();
  ...
  rankConfirmNext() {
    ...
    } else if(window.localStorage.getItem('mainFlagModule5') == '7' || window.localStorage.getItem('mainFlagModule0') == '30' || window.localStorage.getItem('mainFlagModule3') == '7'){
      this.rankModal.hide()
      this.lang.toHide();
  ...
  ngDoCheck() {
    ...
    else if(window.localStorage.getItem('mainFlagModule4')== '5' || window.localStorage.getItem('mainFlagModule4')== '11' || window.localStorage.getItem('mainFlagModule4')== '14' || window.localStorage.getItem('mainFlagModule4')== '8' ||window.localStorage.getItem('mainFlagModule4')== '7'){
      this.queCount = parseInt(window.localStorage.getItem('subFlagModule4'))
    } else if (window.localStorage.getItem('mainFlagModule3') == '11' || window.localStorage.getItem('mainFlagModule3') == '8' || window.localStorage.getItem('mainFlagModule3') == '5')
    {

      this.queCount = parseInt(window.localStorage.getItem('subFlagModule3'));
      console.log("2 queCount ", this.queCount );
