...
let player;
@Component({
  selector: 'app-static-video-module0',
  templateUrl: './static-video-module0.component.html'
})
export class StaticVideoModule0Component implements OnInit {
  public start;
    ...
    if (this.playerReady == true) {
      player.on('stateChange', (event) => {
        ...
        if (event.data === 0) {
          ...
          window.localStorage.getItem('mainFlagModule5') == '14' ||
          window.localStorage.getItem('mainFlagModule5') == '15' ||
          window.localStorage.getItem('mainFlagModule5') == '17' ||
          window.localStorage.getItem('mainFlagModule5') == '19' || window.localStorage.getItem('mainFlagModule5') == '21' || window.localStorage.getItem('mainFlagModule0') == '1' || window.localStorage.getItem('mainFlagModule0') == '2' || window.localStorage.getItem('mainFlagModule5') == '8') {
  ...
  videoFinish() {
    ...
    if (window.localStorage.getItem('mainFlagModule1')) {
      if (window.localStorage.getItem('mainFlagModule1') == '1' || window.localStorage.getItem('mainFlagModule1') == '5' || window.localStorage.getItem('mainFlagModule1') == '11' || window.localStorage.getItem('mainFlagModule1') == '13' || window.localStorage.getItem('mainFlagModule2') == '1' || window.localStorage.getItem('mainFlagModule2') == '10' || window.localStorage.getItem('mainFlagModule2') == '4' || window.localStorage.getItem('mainFlagModule2') == '7' || window.localStorage.getItem('mainFlagModule2') == '13' ||  window.localStorage.getItem('mainFlagModule3') == '1' || window.localStorage.getItem('mainFlagModule3') == '4' || window.localStorage.getItem('mainFlagModule3') == '9'  || window.localStorage.getItem('mainFlagModule3') == '13' || window.localStorage.getItem('mainFlagModule3') == '1' || window.localStorage.getItem('mainFlagModule3') == '16' || window.localStorage.getItem('mainFlagModule4') == '6' || window.localStorage.getItem('mainFlagModule4') == '13' || window.localStorage.getItem('mainFlagModule4') == '1' ||  window.localStorage.getItem('mainFlagModule4') == '9' || window.localStorage.getItem('mainFlagModule5') == '1' || window.localStorage.getItem('mainFlagModule5') == '6' || window.localStorage.getItem('mainFlagModule5') == '14' || window.localStorage.getItem('mainFlagModule5') == '15' || window.localStorage.getItem('mainFlagModule5') == '19' || window.localStorage.getItem('mainFlagModule5') == '21' || window.localStorage.getItem('mainFlagModule5') == '17' || window.localStorage.getItem('mainFlagModule0') == '1' || window.localStorage.getItem('mainFlagModule0') == '2')
