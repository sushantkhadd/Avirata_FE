...
export class LanguageService {
  ...
  constructor(private translate: TranslateService, public toastr: ToastsManager, public router: Router) {
  ...
  handleError(errorMsg) {
    ...
    } else if (errorMsg == "exam not started" || errorMsg == "required quizid key" || errorMsg == "quizid is required" || errorMsg == "useroption is required" || errorMsg == "wrong quizid" || errorMsg == "wrong useroption")
    {
