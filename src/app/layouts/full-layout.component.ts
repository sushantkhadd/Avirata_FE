...
export class FullLayoutComponent implements OnInit {
    ...
    if (this.passwordChange == this.newPasswordChange1) {
      ...
      this.ProfileService.changePassword(
        ...
        data => {
          ...
          } else if (data.Response == "session not matches please re-login") {
            this.toastr.error(
  ...
  currentStatus(moduleNo) {
    if (window.localStorage.getItem("profileComplete") == "false") {
      ...
      this.FullLayoutService.moduleStatus(this.jsonBody).subscribe(
        ...
        err => {
          if (err.json().message == "session not matches please re-login") {
            this.toastr.error(
              "०१४: आपला सेशन कालबाह्य झाला आहे, कृपया पुन्हा  लॉगइन करा."
            );
            setTimeout(() => {
            ...
            err.json().message == "worng module number" ||
            ...
            err.json().message == "json key error" ||
            err.json().message == "current status not available"
          ) {
            ...
            err.json().message == "coordinator not aprroved for this user" ||
            err.json().message == "authorization failed" ||
            err.json().message == "user not in date"
          ) {
            if (moduleNo == 1) {
              this.currentFlag1 = true;
              this.module1OnOffFlag = false;
  ...
  setStatus4(val) {
    if (val == true) {
      ...
      if (
        ...
        source == "module 4.2" ||
        source == "module 4.2.1" ||
        source == "module 4.2.2.1" ||
        source == "module 4.2.2.2" ||
        source == "module 4.2.2.3"
      ) {
        this.mainFlagModule4 = 2;
        if (source == "module 4.2.1") {
          this.subFlagModule4 = 1;
        } else if (source == "module 4.2.2.1") {
          this.subFlagModule4 = 2;
        } else if (source == "module 4.2.2.2") {
          this.subFlagModule4 = 2;
        } else if (source == "module 4.2.2.3") {
          this.subFlagModule4 = 2;
        }
      } else if (source == "module 4.3") {
        this.mainFlagModule4 = 3;
        this.subFlagModule4 = 0;
      } else if (
        source == "module 4.4" ||
        source == "module 4.4.1" ||
        source == "module 4.4.2" ||
        ...
        if (source == "module 4.6.1") {
          ...
          this.subFlagModule4 = 2;
        } else if (source == "module 4.6.3") {
          this.subFlagModule4 = 3;
        } else if (source == "module 4.6.4") {
          this.subFlagModule4 = 4;
        }
      } else if (source == "module 4.7") {
        this.mainFlagModule4 = 7;
        this.subFlagModule4 = 0;
      } else if (
        source == "module 4.8" ||
        source == "module 4.8.1" ||
        source == "module 4.8.1.1" ||
        source == "module 4.8.1.2" ||
        source == "module 4.8.1.3" ||
        source == "module 4.8.2" ||
        source == "module 4.8.3"
      ) {
        ...
        if (
          ...
          this.subFlagModule4 = 1;
        } else if (source == "module 4.8.2") {
          this.subFlagModule4 = 2;
        }
        // else if (source == 'module 4.8.3') {
        //   this.subFlagModule4 = 3;
        // }
      } else if (source == "module 4.9") {
        ...
        source == "module 4.12" ||
        source == "module 4.12.1" ||
        source == "module 4.12.2" ||
        source == "module 4.12.3"
      ) {
        this.mainFlagModule4 = 12;
        if (source == "module 4.12.1") {
          this.subFlagModule4 = 1;
        } else if (source == "module 4.12.2") {
          this.subFlagModule4 = 2;
        } else if (source == "module 4.12.3") {
          this.subFlagModule4 = 3;
        }
      } else if (source == "module 4.13") {
        this.mainFlagModule4 = 13;
        this.subFlagModule4 = 0;
      } else if (
        source == "module 4.14" ||
        source == "module 4.14.1" ||
        source == "module 4.14.2"
      ) {
        this.mainFlagModule4 = 14;
        if (source == "module 4.14.1") {
          this.subFlagModule4 = 1;
        } else if (source == "module 4.14.2") {
          this.subFlagModule4 = 2;
        }
      } else if (source == "module 4.15") {
  ...
  setStatus2(val) {
    ...
    if (val == true) {
      ...
      if (source == "module 2.1.1" || source == "module 2.1.2") {
      ...
      } else if (source == "module 2.2.1" || source == "module 2.2.2") {
        this.mainFlagModule2 = 2;
        if (source == "module 2.2.1") {
          this.subFlagModule2 = 1;
        }
        if (source == "module 2.2.2") {
          this.subFlagModule2 = 2;
        }
        window.localStorage.setItem(
          "subFlagModule2",
      ...
      } else if (source == "module 2.3.1" || source == "module 2.3.2") {
        ...
        source == "module 2.4.1" ||
        source == "module 2.4.2" ||
        source == "module 2.4.2.1" ||
        source == "module 2.4.2.2" ||
        source == "module 2.4.2.3" ||
        source == "module 2.4.3.1" ||
        source == "module 2.4.3.2" ||
        source == "module 2.4.3.3" ||
        source == "module 2.4.3.4" ||
        source == "module 2.4.3.5" ||
        source == "module 2.4.4" ||
        source == "module 2.4.4.1" ||
        source == "module 2.4.4.2" ||
        source == "module 2.4.4.3" ||
        source == "module 2.4.5" ||
        source == "module 2.4.5.1" ||
        source == "module 2.4.5.2" ||
        source == "module 2.4.5.3" ||
        source == "module 2.4.5.4" ||
        source == "module 2.4.5.5" ||
        source == "module 2.4.6" ||
        source == "module 2.4.6.1" ||
        source == "module 2.4.6.2" ||
        source == "module 2.4.6.3" ||
        source == "module 2.4.7" ||
        source == "module 2.4.8" ||
        source == "module 2.4.8.1" ||
        source == "module 2.4.8.2" ||
        source == "module 2.4.8.3" ||
        source == "module 2.4.8.4" ||
        source == "module 2.4.9" ||
        source == "module 2.4.10.1" ||
        source == "module 2.4.10.2"
      ) {
        this.mainFlagModule2 = 4;
        if (source == "module 2.4.0") {
          this.subFlagModule2 = 1;
        } else if (source == "module 2.4.1") {
          this.subFlagModule2 = 2;
        } else if (
          source == "module 2.4.2" ||
          source == "module 2.4.2.1" ||
        ...
        } else if (source == "module 2.4.7") {
          this.subFlagModule2 = 8;
        } else if (
          source == "module 2.4.8" ||
          source == "module 2.4.8.1" ||
          source == "module 2.4.8.2" ||
          ...
          this.subFlagModule2 = 9;
        } else if (source == "module 2.4.9") {
          this.subFlagModule2 = 10;
        } else if (source == "module 2.4.10.1" || source == "module 2.4.10.2") {
          this.subFlagModule2 = 11;
        }
        window.localStorage.setItem(
          "subFlagModule2",
          this.subFlagModule2.toString()
        );
      } else if (source == "module 2.5.1" || source == "module 2.5.2") {
      ...
      } else if (source == "module 2.6.1" || source == "module 2.6.2") {
        this.mainFlagModule2 = 6;
        if (source == "module 2.6.1") {
          this.subFlagModule2 = 1;
        } else if (source == "module 2.6.2") {
          this.subFlagModule2 = 2;
        }
        window.localStorage.setItem(
          "subFlagModule2",
      ...
      } else if (source == "module 2.7") {
        this.mainFlagModule2 = 7;
      }
      // else if (source == 'module 2.8') {
      //   this.mainFlagModule2 = 8;
      // } else if (source == 'module 2.9') {
      //   this.mainFlagModule2 = 9;
      // } else if (source == 'module 2.10') {
      //   this.mainFlagModule2 = 10;
      // } else if (source == 'module 2.11') {
      //   this.mainFlagModule2 = 11;
      // } else if (source == 'module 2.12') {
      //   this.mainFlagModule2 = 12;
      // } else if (source == 'module 2.13') {
      //   this.mainFlagModule2 = 13;
      // } else if (source == 'module 2.14') {
      //   this.mainFlagModule2 = 14;
      // } else if (source == 'module 2.15') {
  ...
  setStatus3(val) {
    if (val == true) {
      ...
      if (source == "module 3") {
        ...
        source == "module 3.8" ||
        source == "module 3.8.1" ||
        source == "module 3.8.2.1" ||
        source == "module 3.8.2.2" ||
        source == "module 3.8.2.3"
      ) {
        ...
        source == "module 3.10" ||
        source == "module 3.10.1.1" ||
        source == "module 3.10.1.2" ||
        source == "module 3.10.1.3" ||
        source == "module 3.10.2.1" ||
        source == "module 3.10.2.2" ||
        source == "module 3.10.2.3"
      ) {
        ...
        source == "module 3.13.3"
      ) {
        this.mainFlagModule3 = 13;
        if (source == "module 3.13.1") {
          this.subFlagModule3 = 1;
        } else if (source == "module 3.13.2") {
          this.subFlagModule3 = 2;
        } else if (source == "module 3.13.3") {
          this.subFlagModule3 = 3;
        }
        window.localStorage.setItem(
          "subFlagModule3",
  ...
  setStatus1(val) {
    if (val == true) {
      ...
      if (source == "module 1.1.1" || source == "module 1.1.2") {
        this.mainFlagModule1 = 1;
        if (source == "module 1.1.1") {
          this.subFlagModule1 = 1;
        } else if (source == "module 1.1.2") {
        ...
        if (source == "module 1.3.1") {
          this.subFlagModule1 = 1;
        } else if (source == "module 1.3.2") {
          this.subFlagModule1 = 2;
        } else if (source == "module 1.3.3") {
          this.subFlagModule1 = 3;
        }
        window.localStorage.setItem(
          "subFlagModule1",
        ...
        if (source == "module 1.5.1") {
          this.subFlagModule1 = 1;
        } else if (source == "module 1.5.2") {
          this.subFlagModule1 = 2;
        } else if (source == "module 1.5.3") {
          this.subFlagModule1 = 3;
        }
        window.localStorage.setItem(
          "subFlagModule1",
        ...
        if (source == "module 1.7.1") {
          ...
          this.subFlagModule1 = 3;
        } else if (source == "module 1.7.4") {
          this.subFlagModule1 = 4;
        } else if (source == "module 1.7.5") {
          this.subFlagModule1 = 5;
        } else if (source == "module 1.7.6") {
          this.subFlagModule1 = 6;
        } else if (source == "module 1.7.7") {
        ...
        if (source == "module 1.8.1") {
          ...
          this.subFlagModule1 = 5;
        } else if (source == "module 1.8.6") {
          this.subFlagModule1 = 6;
        } else if (source == "module 1.8.7") {
          this.subFlagModule1 = 7;
        }
        window.localStorage.setItem(
          "subFlagModule1",
        ...
        if (source == "module 1.9.1") {
          ...
          this.subFlagModule1 = 5;
        } else if (source == "module 1.9.6") {
          this.subFlagModule1 = 6;
        } else if (source == "module 1.9.7") {
          this.subFlagModule1 = 7;
        } else if (source == "module 1.9.8") {
        ...
        source == "module 1.11.3" ||
        source == "module 1.11.4" ||
        source == "module 1.11.5"
      ) {
        this.mainFlagModule1 = 11;
        if (source == "module 1.11.1") {
          this.subFlagModule1 = 1;
        } else if (source == "module 1.11.2") {
          this.subFlagModule1 = 2;
        } else if (source == "module 1.11.3") {
          this.subFlagModule1 = 3;
        } else if (source == "module 1.11.4") {
          this.subFlagModule1 = 4;
        } else if (source == "module 1.11.5") {
          this.subFlagModule1 = 5;
        }
        window.localStorage.setItem(
          "subFlagModule1",
